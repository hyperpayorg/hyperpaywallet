...
func NewEOSWIF(privKey *btcec.PrivateKey, privateKeyID byte, compress bool) (*WIF, error) {
...
// func DecodeHCWIF(wif string) (*WIF, error) {
...
// 	return &WIF{privKey, true, netID}, nil
